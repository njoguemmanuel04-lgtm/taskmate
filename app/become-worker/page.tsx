      ...
      <div className="max-w-md mx-auto p-4">
        <div className="bg-white rounded-2xl p-6 border-2 border-black">
          ...
          <form onSubmit={sub} className="mt-4 space-y-3">
            ...
            <select className="w-full border-2 border-black p-3 rounded-xl font-bold" value={f.skill} onChange={e=>setF({...f,skill:e.target.value})}>
              <option>Cleaning</option><option>Delivery</option><option>Repairs</option><option>Plumbing</option><option>Electric</option><option>Cooking</option><option>Gardening</option>
            </select>
            <select className="w-full border-2 border-black p-3 rounded-xl" value={f.location} onChange={e=>setF({...f,location:e.target.value})}>
              <option>Mwea</option><option>Nairobi</option><option>Mombasa</option><option>Kisumu</option><option>Nakuru</option>
            </select>
