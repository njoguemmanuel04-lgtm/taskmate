...
export default function Page(){
 ...
 return(
  <div style={{padding:16, background:"white", minHeight:"100vh", color:"black"}}>
    <h2 style={{fontWeight:"bold"}}>M-PESA: 0116982197</h2>
    <div style={{border:"2px solid black", padding:16, marginBottom:12, borderRadius:12, marginTop:12}}>
      <b>Daily Try - KES 50</b><br/>1 Day<br/>
    ...
    <div style={{border:"2px solid blue", padding:16, marginBottom:12, borderRadius:12}}>
      <b>Weekly Hustle - KES 250</b><br/>7 Days - TOP search<br/>
    ...
    <div style={{border:"2px solid gold", padding:16, borderRadius:12}}>
      <b>Monthly CEO - KES 799</b><br/>30 Days - ALWAYS TOP<br/>
